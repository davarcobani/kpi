...
CONSTANCE_CONFIG = {
    'REGISTRATION_OPEN': (True, 'Allow new users to register accounts for '
                                'themselves'),
    'TERMS_OF_SERVICE_URL': ('http://www.globalarastirma.com/terms',
                            'URL for terms of service document'),
    'PRIVACY_POLICY_URL': ('http://www.globalarastirma.com/privacy',
                          'URL for privacy policy'),
    'SOURCE_CODE_URL': ('https://github.com/davarcobani/',
...
problems. See
https://github.com/davarcobani/kobocat/blob/master/onadata/libs/utils/user_auth.py.
'''
