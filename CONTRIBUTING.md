...
## Report bugs using GitHub's [issues](https://github.com/davarcobani/kpi/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/davarcobani/kpi/issues/new); it's that easy!
