...
var formViaUrlHelpLink = 'http://help.globalarastirma.com/creating-forms/importing-an-xlsform-via-url';
          ...
          <bem.FormModal__item m='wrapper'>
            ...
            <bem.FormModal__item m='metadata-share'>
              ...
              <label htmlFor="share-metadata">
                {t('Help MobilApp improve this product by sharing the sector and country where this project will be deployed.')}
                &nbsp;
