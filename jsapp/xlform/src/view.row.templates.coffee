module.exports = do ->
  ...
  rowErrorView = (atts)->
    ...
    <div class="card card--error">
      ...
      <em>#{replaceSupportEmail(_t("This question could not be imported. Please re-create it manually. Please contact us at help@globalarastirma.com so we can fix this bug!"))}</em>
    </div>
    #{expandingSpacerHtml}
    """
